...
A collection of philosophical essays by Buddy Williams, written in Markdown. Topics span AI consciousness, economics, epistemology, and what it means to be human in an age of thinking machines. There is no build system, no tests, no application code — only prose.

## Repository Structure

- `essays/` — Full-length essays (the core work)
- `website/static/img/essays/` — Images referenced by essays (link them as `../website/static/img/essays/<file>`)
