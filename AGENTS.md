...
Rooted in critical rationalism (Popper, Deutsch): knowledge grows by conjecture and criticism, and people, human or artificial, are universal explainers. But Buddy disagrees with Popper and Deutsch in places. He holds that induction is primary, because all our knowledge depends on regularities, and at the same time that we are fallible: regularities may be wrong or may change, so we must keep updating and not be limited by our current understanding of them. He holds both views together; they are not contradictory. He also thinks creativity can be an algorithm. Don't "correct" essays toward Popperian orthodoxy; his own view wins. Also systems thinking and economics as coordination under uncertainty. Influenced by Hayek, Sowell, Sagan, Gödel, Turing, Haidt. The central question: how to design systems that remain humane as intelligence becomes abundant.
