...
As a kid I took things apart and tried to put them back together. When my dad showed me a relay, I knew at once it was the part I needed for my tree house security system on my grandparents' farm.
...
1. [The Problem: Closed Minds](#1-the-problem-closed-minds)
2. [How Reason Split](#2-how-reason-split)
3. [What We Lost](#3-what-we-lost)
4. [The Principles of Cyclic Rationality](#4-the-principles-of-cyclic-rationality)
- [Conclusion: Dream, Then Test](#conclusion-dream-then-test)
...
So I set out to understand the difference between how we were thinking. Several ideas came out of that search: Jonathan Haidt's elephant and rider, which echoes Jung's picture of the conscious and unconscious mind; mind viruses, which describe how ideologies spread and take hold by exploiting cognitive weaknesses; and Cyclic Rationality. To see why this narrowness feels so suffocating, it helps to trace how modern reason developed.
...
The same era also split the sciences from the humanities. Once subjectivity became suspect, imagination came to look like an indulgence rather than an instrument of discovery. In *The Two Cultures*, C. P. Snow argued that the growing gulf between the two was a major handicap in solving the world's problems.

The split was never absolute, but I think it helps explain what I saw in my peers. They struggled to speculate or hold a thought experiment for long. Industrial-era education, specialization, and the explosion of formal models all played a part. Logic stopped being a practical tool and became a formal one. And since the world was ablaze with progress, surely nothing was wrong?
...
## 4. The Principles of Cyclic Rationality

### Reality is complex and emergent

The universe organizes itself through local interactions that produce global behavior you couldn't predict from the parts. The whole can't be reduced to its parts without losing something, as cellular automata, chaos theory, and computational irreducibility show.

### Reality is only partly predictable

Some things are predictable and others aren't, and mistakes happen when we draw the line in the wrong place. Predictions come from idealizing a problem: simplifying it while keeping the parts that seem to matter. Every idealization leaves out interactions with the rest of the world. Forget that, and we confuse the map with the territory.
...
**Qualitative rationality** explores possibility space, the set of all the ways information could be combined. **Quantitative rationality** measures and verifies, grounding ideas in evidence and shielding us from delusion. Each fails alone. Qualitative without quantitative produces delusional dreamers. Quantitative without qualitative produces smart idiots, trapped in sterile reductionism.

### Qualitative should come before quantitative

Insight begins with imaginative synthesis, a brave step into the unknown. If verification comes first, we only consider ideas we already know how to measure, and exploration shrinks to fit our instruments. We have to stay open to ideas that outrun today's measurements, because pursuing them is how new methods of measurement get discovered.

### Cyclic Rationality unites the two

Cyclic Rationality is the disciplined alternation between imaginative expansion and empirical contraction, which I think is the rhythm of discovery itself. We dream up possibilities, then try to verify them, knowing we won't always succeed. What survives testing becomes the ground for the next round of dreaming.

## Conclusion: Dream, Then Test

I began by asking why my peers couldn't see what I was seeing. My answer is that they had been trained to verify before they imagined. That order shrinks the world to what can already be measured. Cyclic Rationality restores the order: dream first, then test, then dream again from firmer ground.
...
- [C. P. Snow, *The Two Cultures*](https://en.wikipedia.org/wiki/The_Two_Cultures) (1959)
- Jonathan Haidt, *The Happiness Hypothesis* (2006), the source of the elephant and rider
...
- [Utility of Truth](utility-of-truth.md), on why minds resist changing
- [Thinking About Thinking](thinking-about-thinking.md), on fallibilism as a check on trained reasoning
