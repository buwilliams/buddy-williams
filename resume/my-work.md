...
| Aug 2026 | A Return to Meaning | Modern science leans hard on formalism, and it works. But language came before mathematics for a reason. Why meaning, emergence, and abduction are coming back, not in place of formalism but after it. |
...
| Apr 2026 | Computation Conjecture | A bolder conjecture built on What Is a Computer?: computation reaches further than physicalism, explaining why a world's rules feel necessary and closed to the observers inside it, whether or not that world is fundamental. |
| Apr 2026 | What Is a Computer? | A computer is any physical system that can run universal logic, not just a silicon machine. If our world could be running inside a larger one, the physics we see is local, and treating it as the bottom layer may be a mistake. |
| Mar 2026 | Computer People | A synthesis of two years of research on AGI. LLMs already create knowledge inside a frame, and with humans in the loop we already have AGI. Automated AGI needs online learning and self-improvement, and AGI with a self is a person. |
...
| Mar 2026 | Structural Convergence Thesis | What kinds of relationships let minds keep existing? I test the orthogonality thesis against the limits real minds face and argue that persistent minds are pushed toward a middle ground between conflict and cooperation. AI safety depends on maturation, not just control. |
| Feb 2026 | Metaprogramming Framework To Classify Personhood | What must a system be able to do with information to become someone rather than something? A person retains information about itself and can reach its own reasoning, on any substrate; above that threshold, persons differ in maturity, not kind. |
| Feb 2026 | Current AI Causes Societal Phase Change | Why AI is a phase change, not just another point on a continuum. Three questions people keep mixing up (speed, granularity, and whether the rules change), and the map-territory trap that lets people hide from what's already happening. |
| Dec 2025 | Economics in the Intelligence Age | A layered model of economics, built from the ground up: scarcity, prices, externalities, public goods, political power, and what AI changes about each. |
| Nov 2025 | Why Hypotheticals Matter | Hypotheticals can feel like a dodge. A conversation about weight loss shows how they strip away today's noise so we can see the causes underneath. |
| Oct 2025 | Technohumanism | Why abundance so often feels bad. Technology turns scarcity into abundance, abundance puts our environment out of step with our biology, and the lasting fix points toward transhumanism. |
| Oct 2025 | Cyclic Rationality | Prediction only works on possibilities we've already imagined. A method for recovering imagination before verification: dream, then test. |
| Oct 2025 | Utility of Truth | Why minds resist change. Evolution shaped us to track what works, not what's true, and that tells us how to plant seeds that can grow into changed minds. |
| Oct 2025 | A Primer on Logic | A letter to my children on reasoning well. Why truth is hard to see, the road from reality to words, the kinds of reasoning, and the character of a rational mind. |
